...
use std:: {collections::HashSet, io::stdout, sync::{Arc, Mutex}, time::Duration};
use device_query::{DeviceQuery, DeviceState, Keycode};
use rodio::{Sink, OutputStream};
use synth::{Synth, SynthSource, Slider};
...
fn main(){
    ...
    let mut detune_slider = Slider::new(-1.0, 1.0, slider_width);
